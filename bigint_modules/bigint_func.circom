...
function ldiv(n, k, m, a, b){
    // First non-zero bit of b is like t
    // delete first k-t bits from a and b
    if (k == 0){
        return long_div(n, 1, m, a, b);
    }
    if (b[k - 1] == 0){
        return ldiv(n, k - 1, m, a, b);
    }
    return long_div(n, k, m, a, b);
}
